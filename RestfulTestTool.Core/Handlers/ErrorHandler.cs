...
namespace RestfulTestTool.Core.Handlers
{
    ...
    public class ErrorHandler
    {
        ...
        {
            IList<ConfigError> fatalErrors = allErrors.Where(x => x.Severity = ErrorLevel.Fatal);
            IList<ConfigError> nonFatalErrors = allErrors.Where(x => x.Severity != ErrorLevel.Fatal);
